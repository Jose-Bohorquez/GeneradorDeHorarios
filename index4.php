...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['generate'])) {
        ...
        if (!isset($generatedSchedule['error'])) {
            ...
            header('Location: index-4x4.php?success=1');
            exit;
        } else {
            $error = $generatedSchedule['error'];
        }
...
<head>
    ...
    <title>Generador de Horarios NOC 4x4x4x4</title>
...
<body class="bg-gray-50">
    <div class="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <header class="mb-8 text-center">
            <h1 class="text-3xl font-bold text-indigo-700 mb-2">
                <i class="fas fa-calendar-alt mr-2"></i>Generador de Horarios NOC 4x4x4x4
            </h1>
            <p class="text-gray-600">Sistema de rotación de turnos (4 días por turno)</p>
            ...
            <section class="mb-12">
                <div class="mb-6 text-center">
                    <h2 class="text-2xl font-bold text-gray-800">
                        <i class="fas fa-calendar-check mr-2 text-indigo-600"></i>Horario Generado - 4x4x4x4
                    </h2>
                    <p class="text-gray-600 mt-1">Visualización completa del mes (4 días por turno)</p>
                </div>
    ...
    <footer class="bg-gray-800 text-white py-6">
        <div class="container mx-auto px-4 text-center">
            <p>Sistema de Generación de Horarios NOC 4x4x4x4 &copy; <?= date('Y') ?></p>
        </div>
    </footer>
</body>
</html>